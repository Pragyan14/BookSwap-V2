...
<html lang="en">
  ...
  <body style="margin: 0; padding: 0; background-color: #f4f4f4; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.06);">
      <div style="font-size: 24px; font-weight: bold; color: #333333; margin-bottom: 10px;">
        Welcome to BookSwap, {name}!
      </div>
      <div style="font-size: 16px; color: #555555; margin-bottom: 30px;">
        We're thrilled to have you on board. Start swapping, sharing, and discovering amazing books with the community.
      </div>
      <a href="{ctaLink}" style="display: inline-block; padding: 12px 20px; background-color: #007bff; color: #ffffff; border-radius: 6px; text-decoration: none; font-weight: 500; margin-top: 20px;">
        Start Exploring
      </a>
      <div style="font-size: 12px; color: #999999; text-align: center; margin-top: 40px;">
