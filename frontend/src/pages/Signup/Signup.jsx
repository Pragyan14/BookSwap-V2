  ...
  return (
    <>
      <div
        ...
        {emailSent ? (
          <div className="flex flex-col items-center justify-center mt-10 p-6 rounded-lg bg-green-50 border border-green-200 max-w-md mx-auto text-center shadow-sm">
            <CheckCircle className="w-12 h-12 text-green-600 mb-4" />
            <h2 className="text-xl font-semibold text-green-700">Verify your email</h2>
